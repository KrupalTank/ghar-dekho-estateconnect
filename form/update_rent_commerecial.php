...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE rent_commerecial SET address=?, rent=?, carpetarea=?, image1=?, image2=?, image3=?, image4=? WHERE id=?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("siissssi", $address, $rent, $carpetarea, $i1, $i2, $i3, $i4, $id);
