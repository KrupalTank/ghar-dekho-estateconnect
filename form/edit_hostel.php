...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $query = "SELECT * FROM hostel WHERE id = ?";
...
<body>
    <div class="page">
        ...
        <div class="form-container">
            ...
            <form action="update_hostel.php" class="property-form" method="POST"  enctype="multipart/form-data">
                ...
                <div class="input-group">
                    <label>Fees (₹):</label>
                    <input type="number" name="rent" value="<?php echo $property['fees']; ?>" required><br>
                </div>
                ...
                <div class="input-group">
                    <label>No. Of Persons Per Room:</label>
                    <input type="number" name="persons" value="<?php echo $property['persons']; ?>" required><br>
                </div>
