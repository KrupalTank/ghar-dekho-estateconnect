...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE hostel SET address=?, fees=?, carpetarea=?, persons=?, image1=?, image2=?, image3=?, image4=?  WHERE id=?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("siiissssi", $address, $rent, $carpetarea, $person, $i1, $i2, $i3, $i4, $id);
