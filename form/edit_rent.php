...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $query = "SELECT * FROM rent_home WHERE id = ?";
    ...
    <div class="page">
        ...
        <main>
            ...
            <div class="form-container">
                <form action="update_rent.php" method="POST" class="property-form" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        <label>Rent (₹):</label>
                        <input type="number" name="rent" value="<?php echo $property['rent']; ?>" required><br>
                    </div>
                    ...
                    <div class="input-group">
                        <label>BHK:</label>
                        <input type="number" name="bhk" value="<?php echo $property['bhk']; ?>" required><br>                    
                    </div>
