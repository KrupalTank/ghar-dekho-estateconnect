...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE rent_home SET address=?, rent=?, carpetarea=?, bhk=?, image1=?, image2=?, image3=?, image4=? WHERE id=?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("siiissssi", $address, $rent, $carpetarea, $bhk, $i1, $i2, $i3, $i4, $id);
