...
$query = "SELECT * FROM sale_home NATURAL JOIN user_table WHERE 1";
...
<body>
    <div class="page">
        ...
        <main>
            <div class="textarea">
                <h1>....Find Most Suitable Homes for Sale Here and Live a Happy Life....</h1>
            </div>

            <!-- Search Form -->
            <div class="search-form">
                <form action="Sale_Home.php" method="GET">
