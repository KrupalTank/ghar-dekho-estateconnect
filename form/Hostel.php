...
$searchFees = isset($_GET['fees']) ? $_GET['fees'] : '';
$searchAddress = isset($_GET['address']) ? $_GET['address'] : '';

// Build the base query
$query = "SELECT * FROM hostel NATURAL JOIN user_table WHERE 1";

// If there's a fees filter, add it to the query
if (!empty($searchFees)) {
    $query .= " AND fees <= $searchFees";
}
...
<body>
    <div class="page">
        ...
        <main>
            <div class="textarea">
                <h1>....Find Most Suitable Hostels Here....</h1>
            </div>

            <!-- Search Form -->
            <div class="search-form">
                <form action="Hostel.php" method="GET">
                    <input type="number" name="fees" placeholder="Max Fees" min="0">
